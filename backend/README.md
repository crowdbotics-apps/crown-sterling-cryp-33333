...
## Project Structure
    ...
    ├── crown_sterling_cryp_33333  # Django project configurations
...
1. Clone this repo and `cd crown_sterling_cryp_33333`
...
2. Clone this repo and `cd crown_sterling_cryp_33333`
